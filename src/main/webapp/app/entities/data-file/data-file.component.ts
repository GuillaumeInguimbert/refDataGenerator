...
export class DataFileComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.dataFileService.query({
            ...
            (res: HttpResponse<DataFile[]>) => this.onSuccess(res.body, res.headers),
    ...
    registerChangeInDataFiles() {
        this.eventSubscriber = this.eventManager.subscribe('dataFileListModification', (response) => this.reset());
    }
