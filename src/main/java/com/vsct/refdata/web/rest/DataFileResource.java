...
public class DataFileResource {
    ...
    @Timed
    public ResponseEntity<DataFileDTO> createDataFile(@Valid @RequestBody DataFileDTO dataFileDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<DataFileDTO> updateDataFile(@Valid @RequestBody DataFileDTO dataFileDTO) throws URISyntaxException {
